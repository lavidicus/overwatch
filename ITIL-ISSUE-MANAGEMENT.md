# ITIL Issue Management System

This workspace implements an ITIL-aligned issue management workflow for tracking, managing, and resolving operational incidents, service requests, and problems.
...
- `issues/` - Issue tracking files (YYYY-MM-DD-XXX-format)
- `memory/` - Daily logs and operational notes
- `reports/` - SLA reports, trend analysis, CAB minutes
