...
## Execution Tracking (NEW - 2026-03-14)

This skill is now integrated with the self-improving skills system for automatic performance tracking:

- **Every invocation** is logged with success/failure, errors, tokens, duration
- **Failure analysis** runs automatically when failure rate > 30%
- **Weekly health reports** generated in `reports/skill-health-YYYY-MM-DD.md`
- **Auto-improvement** proposed and tested when performance degrades

**Log location:** `skills/execution-logs/skills-executions.jsonl`
**Report location:** `reports/skill-health-*.md`
...
**To run improvement cycle:**
```bash
python3 skills/self-improving-engine.py improve_skill self-improving
```
