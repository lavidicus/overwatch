...
**Hardware Overview**
- 2 × NVIDIA P6000 GPUs, 24 GB VRAM each, 250 W per GPU (total 500 W sustained)
...
Electricity (0.5 kW × 6 h × $0.16/kWh) | | | **$0.48**
Depreciation (20 % annually on $3,000 hardware) | $600/yr ≈ $1.64/day × 6 h/24 h | | **$0.13**
**Total local cost** | | | **$0.66**

**Cloud‑equivalent comparison (Claude Opus 4.6)**
- Input tokens: $15.00/M × 1.002 M = $15.03
- Output tokens: $75.00/M × 0.067 M = $5.00
- **Total cloud cost:** $20.03
- **Savings vs. cloud:** **$19.37** (≈ 97 %)

**Infrastructure Details**
- Hardware acquisition cost: $3,000
